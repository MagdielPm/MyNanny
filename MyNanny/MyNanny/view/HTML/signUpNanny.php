...
<body>
    ...
    <img src="../../Images/fondoSignUpNanny3" id="fondoSignUpNanny">
    <div class="container">
        <div class="row">
            ...
            <div class="col-4 mx-auto">
                <div class="card card-signin my-5">
                    ...
                    <img src="../../Images/baby5.jpg" class="img-fluid fI2">
                </div>
            </div>
            <div class="col-4 mx-auto">
                <div class="card card-signin my-5">
                    <div class="row justify-content-center ">
                        <br><br><img src="../../Images/map2.png" width="80" height="80">
                    </div>
                    <div class="card-body">
                        <form class="form-signin">
                            <div class="form-label-group">
            ...
            <div class="col-4 mx-auto">
                <div class="card card-signin my-5">
                    ...
                    <div class="card-body">
                        <form class="form-signin">
                            <div class="form-label-group">
                                ...
                                <input type="text" id=edaad class="form-control" placeholder="edad" required>
                                <br>
                            </div>
                            <div class="form-label-group">
                                <label for="sexo"><i class="fas fa-venus-mars"></i> Sexo</label>
                                <input type="text" id="sexo" class="form-control" placeholder="sexo" required>
                                <br>
                            </div>
                    ...
                    <img src="../../Images/baby4.jpg" class="img-fluid fakeimg">
                </div>
